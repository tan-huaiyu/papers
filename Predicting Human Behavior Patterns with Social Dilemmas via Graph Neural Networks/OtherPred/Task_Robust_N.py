...
if __name__ == "__main__":
    # Parameters
    N_num_lst = [i**2 for i in range(5, 21)]
    L = 100
    r = 1.034
    aver_k = 2
    Epoch = 2000
    ...
    MSE_lst = []
    for N_num in N_num_lst:
        print("N = {}".format(N_num))
        print("============ ^^ ============")
        print("============ ^^ ============")
        print("============ Evolutionary Dynamic Process ============")
        g = Pre_Data.Nets(N_num, aver_k).gen_net("BASF")
        ...
        #     "C:/Users/killspeeder/Desktop/PDG_SL_N={}_Evo={}_EvoPre.csv".format(N_num, Evo_size), index=False
        # )
        # pd.DataFrame(pre_perf).to_csv(
        #     "C:/Users/killspeeder/Desktop/PDG_SL_N={}_Evo={}_EvoPef.csv".format(N_num, Evo_size), index=False
        # )
        ...
        # plt.show()
    datas = {'N': N_num_lst, 'mse': MSE_lst}
    pd.DataFrame(datas).to_csv("C:/Users/killspeeder/Desktop/PDG_BASF_N_MSE.csv")
