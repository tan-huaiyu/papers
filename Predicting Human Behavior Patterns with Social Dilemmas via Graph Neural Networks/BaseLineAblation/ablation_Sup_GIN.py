...
if __name__ == "__main__":
    ...
    pd.DataFrame(evo_pre).to_csv("C:/Users/killspeeder/Desktop/abl_GIN_evo.csv", index=False)
    train_pre = {'ACC': ACC, 'F1': F1, 'TPR': TPR, 'FPR': FPR}
    pd.DataFrame(train_pre).to_csv("C:/Users/killspeeder/Desktop/abl_GIN_train.csv", index=False)
