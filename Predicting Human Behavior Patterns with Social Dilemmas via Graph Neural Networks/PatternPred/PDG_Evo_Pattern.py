...
if __name__ == "__main__":
    ...
    pd.DataFrame(y_df).to_csv(
        "C:/Users/killspeeder/Desktop/PDG_SL_Pattern_Evo_y={}.csv".format(Evo_size), index=False
    )
    pd.DataFrame(y_hat_df).to_csv(
        "C:/Users/killspeeder/Desktop/PDG_SL_Pattern_Evo_y_hat={}.csv".format(Evo_size), index=False
    )
