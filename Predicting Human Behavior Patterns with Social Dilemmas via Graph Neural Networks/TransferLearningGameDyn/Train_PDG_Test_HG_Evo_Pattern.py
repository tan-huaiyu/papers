...
if __name__ == "__main__":
    ...
    (margin_data2, T_label2) = Pre_Data.Dynamics(N_num, L, g).game_dyn(r2, "HG")
    ...
    pd.DataFrame(cross_pdg_sdg_evo_pre).to_csv(
        "C:/Users/killspeed_4060ti/Desktop/Cross_PDG_HG_SL_Evo={}_EvoPre.csv".format(Evo_size), index=False
    )
    pd.DataFrame(pre_perf).to_csv(
        "C:/Users/killspeed_4060ti/Desktop/Cross_PDG_HG_SL_Evo={}_EvoPef.csv".format(Evo_size), index=False
    )
    ...
    pd.DataFrame(y_df).to_csv(
        "C:/Users/killspeed_4060ti/Desktop/Cross_PDG_HG_SL_Pattern_Evo_y={}.csv".format(Evo_size), index=False
    )
    pd.DataFrame(y_hat_df).to_csv(
        "C:/Users/killspeed_4060ti/Desktop/Cross_PDG_HG_SL_Pattern_Evo_y_hat={}.csv".format(Evo_size), index=False
    )
